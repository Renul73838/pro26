...
Matter.Body.applyForce(bob2.body,bob2.body.position,{x:-5,y:-45});
Matter.Body.applyForce(bob3.body,bob3.body.position,{x:-5,y:-45});
Matter.Body.applyForce(bob4.body,bob4.body.position,{x:-5,y:-45});
Matter.Body.applyForce(bob5.body,bob5.body.position,{x:-10,y:-45});
	}
}
